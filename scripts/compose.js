...
const genFrontMatter = (answers) => {
  ...
  const destinationArray = answers.destinations.split(',')
  destinationArray.forEach((destination, index) => (destinationArray[index] = destination.trim()))
  const destinations = "'" + destinationArray.join("','") + "'"

  let frontMatter = dedent`---
  title: ${answers.title ? answers.title : 'Untitled'}
  countrycode: ${answers.countrycode ? answers.countrycode : 'Untitled'}
  destinations: [${answers.destinations ? destinations : ''}]
  date: '${date}'
