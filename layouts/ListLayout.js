      ...
      <div className="divide-y">
        <div className="pt-6 pb-8 space-y-2 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            ...
            />
            <svg
              className="searchicon absolute w-5 h-5 text-gray-400 right-3 top-3 dark:text-gray-300"
        ...
        <ul>
          {!filteredBlogPosts.length && t("common:nopostsfound")}
          {displayPosts.map((frontMatter) => {
            const { slug, date, title, summary, tags, countrycode, destinations, images} = frontMatter
            return (
